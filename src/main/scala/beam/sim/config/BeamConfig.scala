// generated by tscfg 0.9.4 on Fri Aug 23 12:19:01 PDT 2019
        ...
        object RideHail {
          ...
          object AllocationManager {
            case class AlonsoMora(
              boostRuntime                     : scala.Boolean,
              maxSizeOfSolutionSpacePerVehicle : scala.Int,
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  boostRuntime                     = c.hasPathOrNull("boostRuntime") && c.getBoolean("boostRuntime"),
                  maxSizeOfSolutionSpacePerVehicle = if(c.hasPathOrNull("maxSizeOfSolutionSpacePerVehicle")) c.getInt("maxSizeOfSolutionSpacePerVehicle") else 5,
